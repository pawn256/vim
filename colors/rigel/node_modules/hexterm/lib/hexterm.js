...
const xtermcolors_1 = __importDefault(require("./xtermcolors"));
const cache = {};
...
function default_1(hex) {
    ...
    const direct = xtermcolors_1.default.findIndex(color => color === hex);
    if (direct !== -1)
        return direct;
    ...
    let similar = 0;
    const closest = {};
    xtermcolors_1.default.forEach((hexcode, i) => {
